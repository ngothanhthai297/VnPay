...
class Request extends \VnPay\PaymentAll\Controller\AbstractCheckoutRedirectAction
{
    public function execute() {
        ...
        $idPayment = $this->_request->getParam('id',false);
        ...
        echo $this->getVnPayRequest($parameter, $customerSession->isLoggedIn());
    }
}
